"""Regression checks for the onyx-trace-flame-probe casebook."""
...
from casebook.harness import assert_expected, onyx_trace_flame_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_trace_flame_probe_summary(), assert_expected())
