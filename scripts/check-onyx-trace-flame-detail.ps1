...
$repo = "onyx-trace-flame-probe"
$language = "Scala"
$category = "Observability"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/onyx-trace-flame-walkthrough.md")) {
